...
var mongoose = require('mongoose');
	mongoose.connect('mongodb://' + environment.OPENSHIFT_MONGODB_DB_USERNAME + ':' + environment.OPENSHIFT_MONGODB_DB_PASSWORD + '@' + $OPENSHIFT_MONGODB_DB_HOST + ':' + $OPENSHIFT_MONGODB_DB_PORT + '/' + environment.dbname);
