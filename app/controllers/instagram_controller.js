...
curl('https://api.instagram.com/v1/subscriptions/', {
	form: 'client_id:98089bfe8f75446cbb15a2a9a7f7d3a5;client_secret:daadb89fd8584c15a99fa8b84a49f049;object:tag;aspect:media;object_id:industrialinvent;callback_url:http://social-industrialinvent.rhcloud.com/api/v1/instagramCallback'
}, function(err) {
	console.log(err);
});
